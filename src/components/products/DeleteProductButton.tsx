...
import { deleteProduct } from "@/app/(app)/produtos/actions";
    ...
    <>
      ...
      >
        <p className="text-sm text-ocean-300 mb-2">
          Tem certeza que deseja remover <strong className="text-white">{productName}</strong> do estoque? Esta ação não poderá ser desfeita.
        </p>
